...
namespace Client.Theme
{
  public class LexTheme
  {
    ...
    public static string BurntOrange = "#A45C40";
    public static string Peach = "#E4B7A0";
    public static string Beige = "#C38370";
    public static string DarkGreen = "#00291C";
    public static string Cream = "#F6EEE0";
